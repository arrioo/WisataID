...
<?php
    ...
    $query = mysqli_query($kon, "SELECT * FROM komentar k inner join wisata a on a.id_wisata=k.id_wisata where id_komentar=$id_komentar");
...
?>
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            <label>wisata:</label>
            <input name="nama" value="<?php echo $nama_wisata; ?>" type="text" class="form-control" disabled>
        </div>
        <div class="form-group">
            <label>Nama:</label>
