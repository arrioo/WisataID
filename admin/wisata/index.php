...
<div class="card mb-4">
    <div class="card-header">
        <button type="button" id="btn-tambah-wisata" class="btn btn-primary"><span class="text"><i class="fas fa-car fa-sm"></i> Tambah data</span></button>
    </div>
    <div class="card-body">
...
<script>
    ...
    $('#btn-tambah-wisata').on('click',function(){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                document.getElementById("nama").innerHTML='Tambah data';
            }
        });
        // Membuka modal
        $('#modal').modal('show');
    ...
    $('.btn-edit-wisata').on('click',function(){
        ...
        $.ajax({
            ...
            success:function(data){
                $('#tampil_data').html(data);  
                document.getElementById("nama").innerHTML='Edit wisata #'+kode_wisata;
            }
        });
        // Membuka modal
        $('#modal').modal('show');
