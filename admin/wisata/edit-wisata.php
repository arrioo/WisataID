    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                <label>Kode:</label>
                <h3><?php echo $data['kode_wisata']; ?></h3>
                <input name="kode_wisata" value="<?php  echo $data['kode_wisata']; ?>" type="hidden" class="form-control">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input name="nama_wisata" type="text" value="<?php  echo $data['nama_wisata']; ?>" class="form-control" placeholder="Masukan nama data" required>
            </div>
        </div>
    </div>
    <!-- rows -->   
