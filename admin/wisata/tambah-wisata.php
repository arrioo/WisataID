...
session_start();
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $nama_wisata=input($_POST["nama_wisata"]);
            ...
            if (!empty($gambar)){
                if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
                    ...
                    //Menambah  dengan gambar
                    $sql="insert into wisata (kode_wisata,nama_wisata,isi_wisata,gambar,tanggal,status,id_kategori) values
                    ('$kode_wisata','$nama_wisata','$isi_wisata','$gambar','$tanggal','$status','$kategori')";
                }    
                
            }else {
                    //Menambah  tanpa gambar, maka gambar_defauilt.png yang akan digunakan
                    $sql="insert into wisata (kode_wisata,nama_wisata,isi_wisata,tanggal,status,id_kategori) values
                    ('$kode_wisata','$nama_wisata','$isi_wisata','$tanggal','$status','$kategori')";
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input name="nama_wisata" type="text" class="form-control" placeholder="Masukan nama data" required>
            </div>
        </div>
    </div>
    <!-- rows -->   
